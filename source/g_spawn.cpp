...
/* KONIG - More Beta Monsters, Q4 Edition*/
void SP_monster_protector(edict_t* self); //Arachnid
void SP_monster_dropper(edict_t* self); //Parasite
void SP_monster_berserk2(edict_t* self); //Berserker
void SP_monster_fixbot2(edict_t* self); //Repair Bot
void SP_misc_marine(edict_t* self); //Insane
...
static const std::initializer_list<spawn_t> spawns = {
	...
	/*KONIG - Added Strogg Betas and Marine*/
